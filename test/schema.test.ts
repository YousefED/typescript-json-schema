...
describe("schema", () => {
    ...
    assertSchema("typeof-keyword", "main.ts", "MyObject", {
        useTypeOfKeyword: true
    })

    assertSchema("user-validation-keywords", "main.ts", "MyObject", {
        validationKeywords: ["chance", "important"]
    })

    assertSchema("generate-required-no-methods", "main.ts", "MyObject", {
        ignoreObjectMethods: true
    })

    assertSchema("no-methods", "main.ts", "MyObject", {
